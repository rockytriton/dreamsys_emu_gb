...
OpCode opCodes[] = {
    ...
    {0x36, "LD HL,n", LD, 2, 12, ATypeIR, {HL, N}},
    {0x37, "DAA", SCF, 1, 4},
    ...
    {0x80, "ADD B", ADD, 1, 4, ATypeR, {B}},
    {0x81, "ADD C", ADD, 1, 4, ATypeR, {C}},
    {0x82, "ADD D", ADD, 1, 4, ATypeR, {D}},
    {0x83, "ADD E", ADD, 1, 4, ATypeR, {E}},
    {0x84, "ADD H", ADD, 1, 4, ATypeR, {H}},
    {0x85, "ADD L", ADD, 1, 4, ATypeR, {L}},
    {0x86, "ADD HL", ADD, 1, 8, ATypeA, {HL}},
    {0x87, "ADD A", ADD, 1, 4, ATypeR, {A}},
    {0x88, "ADD B", ADD, 1, 4, ATypeR, {B}},
    {0x89, "ADD C", ADD, 1, 4, ATypeR, {C}},
    {0x8a, "ADD D", ADD, 1, 4, ATypeR, {D}},
    {0x8b, "ADD E", ADD, 1, 4, ATypeR, {E}},
    {0x8c, "ADD H", ADD, 1, 4, ATypeR, {H}},
    {0x8d, "ADD L", ADD, 1, 4, ATypeR, {L}},
    {0x8e, "ADD HL", ADD, 1, 8, ATypeA, {HL}},
    {0x8f, "ADD A", ADD, 1, 4, ATypeR, {A}},
    ...
    {0xC6, "ADD n", ADD, 2, 8, ATypeNA, {N}},
    {0xC7, "RST 0x00", RST, 1, 16, ATypeNA, {x00}},
    {0xC8, "RET Z", RET, 1, 8, ATypeJ_Z},
    {0xC9, "RET", RET, 1, 16, ATypeJ},
    {0xCA, "JP Z,nn", JP, 3, 12, ATypeJ_Z, {NN}},
    {0xCB, "CB op", CB, 2, 4, ATypeJ},
    {0xCA, "CALL Z,nn", CALL, 3, 12, ATypeJ_Z, {NN}},
    {0xCA, "CALL nn", CALL, 3, 24, ATypeJ, {NN}},
    {0xC6, "ADC n", ADC, 2, 8, ATypeNA, {N}},
    {0xC7, "RST 0x08", RST, 1, 16, ATypeNA, {x08}},
    ...
    {0xF8, "LD HL,SP+e", ADD, 2, 12, ATypeSP, {HL, SP}},
    {0xF9, "LD SP,HL", JP, 1, 8, ATypeNA, {SP, HL}},
